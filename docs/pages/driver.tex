...
\begin{enumerate}
	...
	For our example I've chosen the name \code{PIDGEON\_CARRIER}.
	For consistency the final name is then \code{HW\_ENDPOINT\_PIDGEON\_CARRIER}.

	\item Verify the sizes of integers\\
	Open \filename{inc/types.h} and create a new entry for pidgeon carriers. Perhaps
	...
	Add a pidgeon entry (located above the \code{\#else ... NO INTERFACE DEFINED})
\begin{lstlisting}
...
\end{lstlisting}
	...
	In this example I'm using \filename{pidgeon.h} and \filename{pidgeon.c}.
